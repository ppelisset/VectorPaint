...
public abstract class Figure extends MyObservable implements Cloneable {
	 ...
	 * @return String la rŽprŽsentation sous forme de texte de la figure
	 */
	public abstract String save();
	
	/**
	 * Permet de restaurer une figure ˆ partir de sa reprŽsentation sous forme de texte
	 * @param s
	 * @return
	...
	/**
	 * Permet de dŽcoder une couleur pour l'ouverture d'une figure
	 * @param s
	 * @return
	 */
